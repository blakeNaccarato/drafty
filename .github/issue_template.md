...
<!-- Please verify the issue is present in the latest version by installing it with `pip install drafty==2025.0.0` and checking that the bug is still there #} -->

- [ ] This bug affects version `2025.0.0` of `drafty`.
